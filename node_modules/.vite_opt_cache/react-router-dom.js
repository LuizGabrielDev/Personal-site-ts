import { R as React, r as react } from './common/index-418332a2.js';
...
async function loadLazyRouteModule(route, detectErrorBoundary, manifest) {
  ...
  Object.assign(routeToUpdate, {
    ...
    hasErrorBoundary: detectErrorBoundary(_extends$2({}, routeToUpdate)),
    lazy: undefined
  });
}
...
function detectErrorBoundary(route) {
  if (process.env.NODE_ENV !== "production") {
    if (route.Component && route.element) {
      process.env.NODE_ENV !== "production" ? warning(false, "You should not include both `Component` and `element` on your route - " + "`element` will be ignored.") : void 0;
    }

    if (route.ErrorBoundary && route.errorElement) {
      process.env.NODE_ENV !== "production" ? warning(false, "You should not include both `ErrorBoundary` and `errorElement` on your route - " + "`errorElement` will be ignored.") : void 0;
    }
